...
public class MenuManager : MonoBehaviour
{
    ...
    public void Continue()
    {
        ...
        //--------------------------------------------------------------------------------
        Debug.Log("TƒƒLLƒ EKAA BUILDIA VARTEN TOISEEN KENTTƒƒN LOPPUVA TEMP KOODI");
        // if else on k‰ytˆss‰ vain ekassa buildissa ku npeli loppuu kakkoskent‰n j‰lkeen
        ...
        //t‰m‰ on oikea ja k‰ytˆss‰ jatkossa kun eka buildi on buildattu
        //GameModeManager.instance.CheckBonusLevelAccess();
